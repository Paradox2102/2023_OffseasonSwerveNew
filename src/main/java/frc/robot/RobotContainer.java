...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
    PathPlannerPath path = PathPlannerPath.fromPathFile("yay");
    return AutoBuilder.followPathWithEvents(path);

    // PathPlannerTrajectory path = PathPlanner.loadPath("yay", new PathConstraints(Constants.k_maxSpeedMetersPerSecond, Constants.k_maxDriveAcceleration));
