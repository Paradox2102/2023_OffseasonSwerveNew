...
public class ElevatorSubsystem extends SubsystemBase {
  ...
  Follower m_followYay = new Follower(Constants.k_elevatorMotor, true);

  /** Creates a new ElevatorSubsystem. */
  public ElevatorSubsystem() {
    m_motor.setPosition(0);
    m_follower.setPosition(0);
    m_follower.setControl(m_followYay);
  ...
  private double getExtentInches() {
    return getPosition() * Constants.k_elevatorTicksToInches;
  }
  ...
  public void periodic() {
    ...
    runP();
    checkLimitSwitches();
    SmartDashboard.putNumber("Elevator Extent", getPosition() * Constants.k_elevatorTicksToInches);
    SmartDashboard.putBoolean("Bottom Switch", m_bottomSwitch.get());
